...
const experiences = [
  {
    ...
    type: "Full-time",
    description: "Leading fullstack web application development with modern technologies",
    achievements: [
    ...
    technologies: ["React.js", "Next.js", "Node.js", "TypeScript", "SQL", "Docker"]
  },
  {
    company: "Super1",
    ...
    type: "Contract",
    description: "Marketplace platform development with focus on user experience",
    achievements: [
  ...
  },
  {
    ...
    type: "Contract",
    description: "Educational platform development and legacy system modernization",
    achievements: [
...
const ExperienceSection = () => {
  ...
  return (
    <section id="experience" ref={sectionRef} className="section-padding bg-neutral-50">
                    ...
                    <ul className="space-y-2">
                      {exp.achievements.map((achievement, i) => (
                        <li key={i} className="flex items-start">
                          ...
                          <span className="text-body text-neutral-600">{achievement}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {exp.technologies.map((tech) => (
                        <Badge key={tech} variant="outline" className="border-neutral-300">
                          {tech}
                        </Badge>
                      ))}
                    </div>
