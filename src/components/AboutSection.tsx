...
const AboutSection = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="section-padding bg-neutral-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={contentRef} className="space-y-8">
            ...
            <div className="space-y-6 text-body text-neutral-600">
              <p>
                With 3+ years of Full Stack development experience and a Software Engineering degree 
                from UniCesumar, I specialize in building scalable web applications that solve real business problems.
              </p>
              
              <p>
                My journey was accelerated through Rocketseat's intensive bootcamp, where I mastered modern 
                technologies and best practices. I focus on creating simple, efficient solutions while 
                constantly seeking technical challenges that drive my growth.
              </p>
              
              <p>
                I believe in clean code, scalable architecture, and delivering exceptional user experiences 
                that drive business results for clients across the globe.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <Card className="p-6 text-center hover-shadow">
                <div className="text-2xl font-bold text-neutral-900 mb-2">15+</div>
