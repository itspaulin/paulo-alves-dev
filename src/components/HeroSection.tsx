  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container-width text-center z-10">
        ...
        >
          Building scalable web applications and performant APIs with React, Next.js, and Node.js for 3+ years. 
          Transforming ideas into digital solutions for clients worldwide.
        </p>
